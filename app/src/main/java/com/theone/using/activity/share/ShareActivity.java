...
public class ShareActivity extends BaseActivity implements LocationSource,
...
//                            AMapUtil.convertToLatLng(latLonPoint), 15));
                    ...
                    ToastUtil.show(ShareActivity.this, R.string.no_result);
                }
            } else {
                ToastUtil.showerror(ShareActivity.this, rCode);
            }
    ...
    private class MyOnClickListener implements View.OnClickListener {
        ...
        public void onClick(View v) {
            ...
            if (id == R.id.btn_share) {
                ...
                System.out.println(""+shareMarker.getPosition().latitude+" "+shareMarker.getPosition().longitude);
                ShareDetailsActivity.actionStart(ShareActivity.this,bundle);
                ShareActivity.this.finish();
            }
        }
    }
